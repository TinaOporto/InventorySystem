    ...
    public partial class ItemsForm : MetroForm
    {
        ...
        public void Delete(string ID)
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MetroMessageBox.Show(this, "Deleted successfully", "Delete");
                connection.Close();
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in this.inventory_grid.Rows)
            {
                ...
                DialogResult dr = MetroMessageBox.Show(this, "Do you want to delete this?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
