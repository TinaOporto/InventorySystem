...
namespace LoginForm
{
    public partial class DesignationForm : MetroForm
    {
        ...
        private void LoadAllEmployee()
        {
            ...
            //    while (dataReader.Read())
            //    {
            //        emname_txt.Items.Add(dataReader["em_fname"] + " " + dataReader["em_lname"] + "");
            //    }
        ...
        private void LoadAllItem()
        {
            ...
            //    while (dataReader.Read())
            //    {
            //        itemname_txt..Add(dataReader["item_name"] + "");
            //    }
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
           // connection = new MySqlConnection(ConnectionString);
            ...
            if (IsInserting == true)
            {
                ...
                //string str = "Select count(*) from designation_info where item_serial = '" + mtxt_serial.Text + "'";
                //MySqlCommand cmd = new MySqlCommand(str, connection);
                //int itemExist = Convert.ToInt32(cmd.ExecuteScalar());
                //if (itemExist > 0)
                //{
                //    MetroMessageBox.Show(this, "Cannot assign item, someone else's using this.", "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                //    btn_cancel.PerformClick();
                //    return;
                //}
