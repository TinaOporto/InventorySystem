    ...
    public partial class TransactionForm : MetroForm
    {
        ...
        private void LoadAllTransaction()
        {
            ...
            try
            {
                ...
                {
                    transac_grid.Rows.Add(dataReader["tid"] + "", Convert.ToDateTime(dataReader["trans_date"]).ToString("yyyy-MM-dd"), dataReader["quantity"] + "", dataReader["price"] + "", dataReader["supplier"] + "", dataReader["warranty"] + "", dataReader["receipts"] + "", dataReader["iid"] + "");
                }
